...
export async function POST(req: NextRequest) {
  try {
          ...
          <html>
            <head>
              ...
              <style>
                ...
                .label { font-weight: bold; color: #667eea; font-size: 14px; margin-bottom: 5px; }
                .value { margin-top: 5px; padding: 12px; background: white; border-left: 4px solid #667eea; border-radius: 4px; word-wrap: break-word; }
    ...
    return NextResponse.json(
      { error: "Server error occurred", details: errorMessage, stack: process.env.NODE_ENV === "development" ? errorStack : undefined },
      { status: 500 }
    );
  }
}
