  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-5xl mx-auto px-6 py-16 space-y-8 text-gray-800 leading-relaxed">
        ...
        <h2 className="text-3xl font-serif text-center text-red-600 mb-6">
          Our Story
        </h2>

        <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 p-8 rounded-2xl shadow-lg space-y-6">
          <p>
            <strong className="text-red-600">Vivaah Tales</strong>, a unit of 
          ...
          <p>
            ...
            <strong className="text-red-600"> Vivaah Tales</strong>, a name 
          ...
          <p>
            After receiving the 
            <strong className="text-red-600"> Best Wedding Photography Award (2023)</strong>, 
        ...
        <h3 className="text-3xl font-serif text-center text-red-600 mt-12">
          Contact Details
        </h3>
        ...
        <div className="bg-gradient-to-br from-amber-50 to-orange-50 border-2 border-amber-200 p-8 rounded-2xl shadow-lg space-y-4">
          ...
          <p>
            <strong>Phone:</strong>{" "}
            <a href="tel:+919851678337" className="text-red-600 underline hover:text-red-700 font-semibold">
              +91 9851678337
            </a>
          </p>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-20">
        ...
        <form
          ...
          className="bg-gradient-to-br from-red-50 via-red-100 to-purple-50 border-2 border-red-300 p-10 rounded-2xl shadow-2xl space-y-6"
        >
          <input
            name="name"
            required
            ...
            disabled={isLoading}
            className="w-full p-4 border-2 border-red-300 rounded-xl bg-white focus:ring-2 focus:ring-red-400 focus:border-red-400 transition"
          />
          ...
          <textarea
            ...
            disabled={isLoading}
            className="w-full p-4 border-2 border-red-300 rounded-xl bg-white resize-none focus:ring-2 focus:ring-red-400 focus:border-red-400 transition"
          />
